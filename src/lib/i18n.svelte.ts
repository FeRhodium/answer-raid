...
const DICT: Record<Lang, Record<string, Message>> = {
  zh: {
    ...
    'promote.in.1': '本档开始考「名词」:模型、框架、数据结构,平时关注技术圈就有优势。',
    'promote.in.2': '答错即出局,三题之内必须全对。',
    'promote.in.3': '拿不准就回想它在解决什么问题,而不是背它的名字。',
    'promote.at.1': '警告:本档题目涉及未定义行为、内存布局与硬件语义。',
    'promote.at.2': '直觉在这里通常是错的 —— 请从定义与位级事实出发。',
    'promote.at.3': '不灭次数重置为 1,答错即出局。',
    'promote.sp.1': '最终关卡:计算理论与算法,读懂定义比套公式管用。',
    'promote.sp.2': '答错即出局,想清楚了再点。',
    'promote.sp.3': '通过后你将被记录为「封神」候选。',
    ...
    'tier.at.label': '高阶',
    'tier.at.desc': '底层与硬件语义 · 不容想当然',
    'tier.sp.label': '特殊',
    'tier.sp.desc': '压轴难档 · 答对即封神',
  ...
  en: {
    ...
    'promote.in.1': 'This tier starts testing names: models, frameworks, data structures.',
    'promote.in.2': 'One wrong answer ends the run, so all three must be right.',
    'promote.in.3': 'If unsure, recall what it solves rather than what it is called.',
    'promote.at.1': 'Warning: this tier covers undefined behaviour, memory layout and hardware semantics.',
    'promote.at.2': 'Intuition is usually wrong here — reason from definitions and bit-level facts.',
    'promote.at.3': 'Lives reset to 1. One wrong answer ends the run.',
    'promote.sp.1': 'Final tier: theory of computation and algorithms — reading the spec beats memorising.',
    'promote.sp.2': 'One wrong answer ends the run, so think before you click.',
    'promote.sp.3': 'Clear this and you are recorded as a candidate for godhood.',

    'rank.SSS': 'Flawless clear · ascended',
    'rank.SS': 'Cleared the SP tier',
    'rank.S': 'Reached the SP tier',
    'rank.A': 'Made it to AT',
    'rank.B': 'Made it to IN',
    'rank.C': 'Past EZ and HD',
    ...
    'tier.at.label': 'AT',
    'tier.at.desc': 'Low-level and hardware semantics',
    'tier.sp.label': 'SP',
    'tier.sp.desc': 'The final tier — clear it and ascend',
